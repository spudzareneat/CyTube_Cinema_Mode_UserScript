...
function fillHeaderTemplate(templateSrc, { version, grants, connects, requires }) {
    ...
    return templateSrc
        ...
        // the raw LF bytes GitHub Pages serves to docs/customizer.js,
        // leaving a stray, unprefixed "{{REQUIRES}}" in the generated
        // header -- which then parses as (meaningless-but-valid) JS and
        // throws `ReferenceError: REQUIRES is not defined` at script load.
