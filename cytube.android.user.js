...
(function () {
    ...
    function installChatTextarea() {
        ...
        textarea.setAttribute('inputmode', 'text'); // ensure touch keyboard appears
    ...
    window.addEventListener('load', () => {
        ...
        style.textContent = `
            ...
            body.sc-vertical .video-js .vjs-control-bar {
                bottom: 42vh !important; /* sit just above the chat panel */
            ...
            body.sc-vertical #videowrap {
                position: fixed !important; top: 0 !important; left: 0 !important;
                width: 100vw !important; height: 58vh !important;
                z-index: 9999 !important; background: black !important;
            }
            ...
            @media (pointer: coarse) {
                ...
                #sc-emote-proxy, #fs-toggle-btn, #sc-settings-btn {
